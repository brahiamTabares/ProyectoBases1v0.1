...
CREATE TABLE historiaclinica ( nombre VARCHAR(20) NOT NULL, sexo VARCHAR(20), fecha_ingreso DATE, fechasalida DATE, mascota_id VARCHAR(20) NOT NULL );
...
CREATE TABLE registro (codigo VARCHAR(20) NOT NULL,observaciones VARCHAR(20),concepto VARCHAR(20),decisiones VARCHAR(20),fecharegistro DATE,examenes_codigo VARCHAR(20) NOT NULL,historiaclinica_mascota_id VARCHAR(20) NOT NULL );
...
CREATE TABLE serviciocentro ( idser VARCHAR(20) NOT NULL, idcen VARCHAR(5) NOT NULL, servicio_id VARCHAR(20) NOT NULL, centroservicio_usuario_id VARCHAR(20) NOT NULL );
ALTER TABLE serviciocentro ADD CONSTRAINT servicio_centro_pk PRIMARY KEY ( idcen, idser );
